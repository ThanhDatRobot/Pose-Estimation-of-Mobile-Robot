...
square_size = 0.07 # Size, in meters, of a square side 
...
def main():
  ...
  images = glob.glob('Chessboard_to_Calib/*.png') + glob.glob('Chessboard_to_Calib/*.jpg')
  ...
  for image_file in images:
    ...
    if success == True:
      ...
      # Draw the corners
      cv2.drawChessboardCorners(resized_image, (nX, nY), corners_2, success)
